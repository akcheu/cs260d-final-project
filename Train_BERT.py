...
def train(model, train_loader, val_loader, optimizer):  
  ...
  for epoch in range(EPOCHS):
    ...
    plt.title('BERT - MNLI Class Accuracies', fontsize=15, fontweight='bold')
    plt.xlabel('Class', fontsize=12)
    plt.ylabel('Contains Negation Word (Spurious)', fontsize=12)
    plt.savefig(f'plots/BERT_{epoch}.png')
    print('\n')

  plt.figure()
  plt.plot(train_loss_values)
  plt.title('BERT - Train Loss', fontsize=15, fontweight='bold')
  plt.xlabel('Epoch', fontsize=12)
  plt.ylabel('Loss', fontsize=12)
  plt.savefig(f'plots/BERT_TrainLoss.png')

  plt.figure()
  plt.plot(val_loss_values)
  plt.title('BERT - Validation Loss', fontsize=15, fontweight='bold')
  plt.xlabel('Epoch', fontsize=12)
  plt.ylabel('Loss', fontsize=12)
  plt.savefig(f'plots/BERT_ValLoss.png')

  model.save_pretrained("BERT", from_pt=True)
